...
public class Projectile {
  public static SnowballEntity create(ServerWorld world, LivingEntity caster, Vec3d pos, Vec3d dir, String spell) {
    Vec3d vel = dir.normalize().multiply(0.1);
    SnowballEntity ent = new SnowballEntity(EntityType.SNOWBALL, world);
    ent.setOwner(caster);
  ...
  public static void execute(SnowballEntity ent, LivingEntity target) {
